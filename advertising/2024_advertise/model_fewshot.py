...
args_dict = dict(
    data_dir="fewshot_dataset/filtered_data_new_data_pred_12shot.csv", # path for data files
...
class T5FineTuner(pl.LightningModule):
  ...
  def training_epoch_end(self, outputs):
    ...
    acc, recall, precision = self.cal_acc('fewshot_dataset/filtered_data_novel_class_pred_12shot.csv')
  ...
  def validation_epoch_end(self, outputs):
    ...
    acc, recall, precision = self.cal_acc('fewshot_dataset/filtered_data_novel_class_test.csv')
  ...
  def train_dataloader(self):
    train_dataset = MyDataset(self.tokenizer, 'fewshot_dataset/filtered_data_novel_class_pred_12shot.csv')
  ...
  def val_dataloader(self):
    val_dataset = MyDataset(self.tokenizer,'fewshot_dataset/filtered_data_novel_class_test.csv')
